<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"/var/www/html/school/public/../application/index/view/student/index.html";i:1513931186;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-group">
    ...
    <div class="page">
        ...
        <header class="bar bar-nav" style="background-color: #e6e6e6">
            <a class="button button-link button-nav pull-left external" href="<?php echo url('teacher/home'); ?>" style="color: #999999">
            ...
            <div class="searchbar pull-right" style="width: 95%;background-color: #e6e6e6">
                ...
                <div class="search-input">
                    ...
                    <input type="search" id="searchval" value="<?php echo $name; ?>" placeholder="搜索"/>
                </div>
            </div>
        </header>
                    ...
                    <div id="tab2" class="tab">
                        <div class="content-block">
                            ...
                            <div class="common" onclick="javascript:window.location.href = '<?php echo url('student/groupdetail',['sgid'=>$vo['sgid']]); ?>'"><span class="icon icon-right pull-right" style="margin-right: 16px"></span>
                                    <span class="pull-right smatext"><?php echo count(explode(',',substr($vo['sids'],0,-1))); ?>名</span>
