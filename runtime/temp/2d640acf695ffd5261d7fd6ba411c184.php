<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"/var/www/html/school/public/../application/index/view/arrange/choosep.html";i:1514876888;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="tabs">
                    ...
                    <div id="tab2" class="tab">
                        <div class="content-block">
                            ...
                            <div class="common">
                                <label for="<?php echo $vo['gid']; ?>" class="ortex"><input id="<?php echo $vo['gid']; ?>" onclick="guardia(this.value)" style="display: none" value="<?php echo $vo['mobile']; ?><?php echo $vo['gname']; ?>*<?php echo $sids; ?>"><?php echo $vo['gname']; ?></label>
