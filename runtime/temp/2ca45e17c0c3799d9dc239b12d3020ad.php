<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"/var/www/html/school/public/../application/admin/view/manager/edit.html";i:1513070142;s:69:"/var/www/html/school/public/../application/admin/view/common/top.html";i:1513768045;s:70:"/var/www/html/school/public/../application/admin/view/common/left.html";i:1512960216;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
	    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">管理员编号</label>
                            <div class="col-sm-6">
                                <input class="form-control" disabled="disabled" value="<?php echo $admin['aid']; ?>" required="" type="number">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                            <div class="col-sm-6">
                                <input class="form-control" id="sid" value="<?php echo $admin['aid']; ?>" name="aid" type="hidden">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="username" value="<?php echo $admin['name']; ?>" name="name" required="" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="" value="<?php echo $admin['mobile']; ?>" name="mobile" required="" type="number">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" value="<?php echo $admin['account']; ?>" name="account" required="" type="text">
                            </div>
                        </div>
