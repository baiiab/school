<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"D:\kinggsoft\phpstudy\WWW\school\public/../application/mobil\view\student\addstudent.html";i:1512288641;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="page">
        ...
        <div class="content">
            ...
            <div class="common">
                ...
                <hr/>
                <p class="smalltex"><span class="icon icon-down pull-right" id="sp" style="margin-right: 0.5rem;"></span>
