<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"D:\kinggsoft\phpstudy\WWW\school\public/../application/admin\view\student\addclass.html";i:1510131398;s:81:"D:\kinggsoft\phpstudy\WWW\school\public/../application/admin\view\common\top.html";i:1510920761;s:82:"D:\kinggsoft\phpstudy\WWW\school\public/../application/admin\view\common\left.html";i:1510805509;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
	    <meta charset="utf-8">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="#">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('lst'); ?>">学员列表</a>
                    </li>
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('Student/addClass'); ?>" method="post">
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">班级</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="cid" placeholder="" name="cid" required="" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>

                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">所属专业</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="majors" placeholder="" name="majors" type="text">
                            </div>
                        </div>

                        <div class="form-group">
                            <label for="group_id" class="col-sm-2 control-label no-padding-right">开班年份</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="year" placeholder="" name="year" required="" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>  
                        <div class="form-group">
