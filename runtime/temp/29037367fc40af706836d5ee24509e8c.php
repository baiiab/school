<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"/var/www/html/school/public/../application/index/view/student/chooses.html";i:1513930790;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="page page-current" id='router'>
        ...
        <nav class="bar bar-tab" id="tools">
            ...
            <span class="tab-item external tooltex" style="width: 3%" onclick="change();">
                <span class="tab-label" style="color: #FFFFFF">添加学员</span>
            </span>
        </nav>
        ...
        <div class="content">
            <div class="content-block">
                ...
                <?php if(is_array($stud) || $stud instanceof \think\Collection || $stud instanceof \think\Paginator): $i = 0; $__LIST__ = $stud;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <label for="<?php echo $vo['sid']; ?>"><div class="news-item clearfix">
                    <input onchange="changeimg(this);" checked="checked" class="pull-left" style="display: none;margin-top: 1.1rem" value="<?php echo $vo['sid']; ?>" type="checkbox" id="<?php echo $vo['sid']; ?>" name="chk"><img id="<?php echo $vo['sid']; ?>1" class="pull-left ssmall ssmalli" src="__IMG__/ios/icon_checkbox_checked@3x.png">
                ...
                <?php endforeach; endif; else: echo "" ;endif; if(is_array($student) || $student instanceof \think\Collection || $student instanceof \think\Paginator): $i = 0; $__LIST__ = $student;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <label for="<?php echo $vo['sid']; ?>"><div class="news-item clearfix">
...
<script>
    $(function () {
        $('#search').click(function () {
            ...
            window.location.href = '?name='+$('#searchval').val()+'&sgid='+$('#sgid').val()+','+$('#name').val();
        });
    })
    function change() {
        var str = '';
...
//        str = str.substr(0,str.length-1);
        ...
        window.location.href = '/school/public/index/student/groupdetail?sid='+str+'&sgid='+$('#sgid').val()+'&name='+$('#name').val();
    }
