<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"D:\kinggsoft\phpstudy\WWW\school\public/../application/index\view\student\classdetail.html";i:1512375250;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-group">
    ...
    <div class="page">
        <header class="bar bar-nav title1">
            ...
            <h1 class="title titleh">班级详情</h1>
        </header>

        <div class="content">
            <div class="common" style="background-color: #FFFFFF;border-bottom: 0.1rem solid #c2ccd1;margin-bottom: 10px">
                <span class="pull-right smalltex" style="margin-right: 18px"><?php echo $cid; ?></span>
                <span class="smalltex" style="margin-left: 0.5rem">班级名称</span>
            </div>
            ...
            <div class="center-item">
                ...
                <div class="item-p">
                    ...
                    <p class="item-p2"><?php echo $vo['sex']; ?></p>
                </div>
            </div>
