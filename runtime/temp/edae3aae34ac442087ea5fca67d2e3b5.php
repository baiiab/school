<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"D:\kinggsoft\phpstudy\WWW\school\public/../application/mobil\view\transinfo\handtran.html";i:1513237762;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-group">
    ...
    <div class="page page-current" id='router'>
        ...
        <div class="content">
            ...
            <a class="external" href="<?php echo url('arrange/index'); ?>"><div class="news-item" style="background-color: #F4FDF1">
                <div class="news-image">
        ...
        <div class="content">
            ...
            <div class="common" onclick="javascript:window.location.href = '<?php echo url('transinfo/recedetail',['tid'=>$vo['tid']]); ?>'">
                <div class="common-left" style="margin-top: 0.2rem">
                    <p class="router-boldtex">安排交接人：<?php echo $vo['name']; ?></p>
