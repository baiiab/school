<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"/var/www/html/school/public/../application/admin/view/student/edit.html";i:1513846758;s:69:"/var/www/html/school/public/../application/admin/view/common/top.html";i:1513768045;s:70:"/var/www/html/school/public/../application/admin/view/common/left.html";i:1512960216;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
	    <meta charset="utf-8">
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">编辑学员</span>
            </div>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" disabled="disabled" value="<?php echo $admin['sid']; ?>" required="" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                            <div class="col-sm-6">
                                <input class="form-control" id="sid" value="<?php echo $admin['sid']; ?>" name="sid" type="hidden">
                            </div>
                        </div>
                        <div class="form-group">
