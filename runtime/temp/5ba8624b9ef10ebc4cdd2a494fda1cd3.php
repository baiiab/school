<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"/var/www/html/school/public/../application/index/view/arrange/index.html";i:1514876888;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <div class="content-block">
                            ...
                            <div class="news-item clearfix">
                                ...
                                <div style="float: left;">
                                    <p class="boldtex"><?php echo $vo['name']; ?></p>
                                    <p class="smalltex" style="margin-top: 0.2rem"><?php echo $vo['sex']; ?>&nbsp;<?php echo $vo['cid']; ?></p></div>
                                <span class="pull-right smalltex" style="margin-top: 1.3rem;margin-right: 10px">接收人：<?php if(isset($vo['tname'])): ?><?php echo $vo['tname']; else: ?><?php echo $vo['gname']; endif; ?></span>
                            </div>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </div>
                    </div>
                    ...
                    <div id="tab4" class="tab">
                        <div class="content-block">
                            ...
                            <div class="news-item clearfix">
                                ...
                                <p class="smalltex" style="margin-top: 0.2rem"><?php echo $vo['reason']; ?><span class="pull-right smalltex" style="margin-right: 10px">驳回人：<?php if(isset($vo['tname'])): ?><?php echo $vo['tname']; else: ?><?php echo $vo['gname']; endif; ?></span></p></div></div>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function change() {
        ...
        window.location.href = '/school/public/index/arrange/choosep?sid='+str;
    }
    function allchoose() {
