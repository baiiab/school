<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"/var/www/html/school/public/../application/admin/view/attendance/evection.html";i:1513070142;s:69:"/var/www/html/school/public/../application/admin/view/common/top.html";i:1513768045;s:70:"/var/www/html/school/public/../application/admin/view/common/left.html";i:1512960216;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
//            alert(document.getElementById("search").value);die;
            window.location.href = "searchevection?id="+document.getElementById("search").value;
        }
    </script>
</head>
<body>
...
<div class="row">
                    ...
                    <table class="table table-bordered table-hover"  style="overflow: scroll">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center">出差时间段</th>
                                <th class="text-center">出差地点</th>
                                <th class="text-center">出差目的</th>
                                <th class="text-center">工作交接人</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php if(is_array($students) || $students instanceof \think\Collection || $students instanceof \think\Paginator): $i = 0; $__LIST__ = $students;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                ...
                                <td align="center"><?php echo $vo['asktime']; ?></td>
                                <td align="center"><?php echo $vo['holidaytime']; ?></td>
                                <td align="center"><?php echo $vo['place']; ?></td>
                                <td align="center"><?php echo $vo['purpose']; ?></td>
                                <td align="center"><?php echo $vo['tutor']; ?></td>
                            </tr>
    ...
    <script src="__PUBLIC__/laydate.js"></script>
