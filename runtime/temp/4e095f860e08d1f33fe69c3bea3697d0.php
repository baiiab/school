<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"/var/www/html/school/public/../application/index/view/arrange/confirm.html";i:1515037500;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-group">
    ...
    <div class="page">
        ...
        <nav class="bar bar-tab tooltex" id="tools">
            <span class="tab-item external confirm-ok">
        ...
        <div class="content">
            <div class="common" style="background-color: #FFFFFF;border-bottom: 0.1rem solid #c2ccd1;">
                <span class="pull-right smalltex" style="margin-right: 0.5rem"><?php echo $sname; ?></span>
                <span class="boldtex" style="margin-left: 0.5rem">接收人</span>
            </div>
            <input type="hidden" value="<?php echo $sid; ?>,<?php echo $sgid; ?>" id="value">
            <div class="commo">
...
<script>
    $(function () {
        $(document).on('click','.confirm-ok', function () {
            $.confirm('确认安排吗？', function () {
                window.location.href = '/school/public/index/arrange/change?value='+$('#value').val();
            });
        });
