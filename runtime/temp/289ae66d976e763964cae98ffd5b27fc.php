<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"D:\kinggsoft\phpstudy\WWW\school\public/../application/index\view\transinfo\recedetail.html";i:1512633318;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="page">
        ...
        <nav class="bar bar-tab" id="tools">
            ...
            <span class="tab-item external tooltex">
                <span class="tab-label" style="color: #FFFFFF" onclick="change();">确认接收</span>
            </span>
        </nav>
            ...
            <div class="content-block">
                <div class="tabs">
                    ...
                    <div id="tab3" class="tab">
                        <div class="content-block">
                            <?php if(is_array($bstudent) || $bstudent instanceof \think\Collection || $bstudent instanceof \think\Paginator): $i = 0; $__LIST__ = $bstudent;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <div class="news-item clearfix">
                                <div class="news-image">
...
//            }
    ...
    function change() {
        ...
        ajax.open('get', '__JQUERY__/public/index/transinfo/receive?sid=' + str, true);
        ajax.send(null);
    }
    function allchoose() {
