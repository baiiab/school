<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"/var/www/html/school/public/../application/admin/view/guardian/edit.html";i:1514876887;s:69:"/var/www/html/school/public/../application/admin/view/common/top.html";i:1513768045;s:70:"/var/www/html/school/public/../application/admin/view/common/left.html";i:1512960216;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
	    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" disabled="disabled" value="<?php echo $admin['gid']; ?>" required="" type="number">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" disabled="disabled" id="" value="<?php echo $admin['mobile']; ?>" name="mobile" required="" type="number">
                            </div>
                        </div>
