<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"D:\kinggsoft\phpstudy\WWW\school\public/../application/index\view\student\groupdetail.html";i:1512385768;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-group">
    ...
    <div class="page">
        <header class="bar bar-nav title1">
            ...
            <h1 class="title titleh">分组详情</h1>
        </header>

        <nav class="bar bar-tab tooltex" id="tools">
            <span class="tab-item external" style="background-color: #F52525">
                <span class="tab-label" style="color: #FFFFFF" id="delete">删除</span>
            </span>
            <span class="tab-item external">
                <span class="tab-label" style="color: #FFFFFF" id="change">确定</span>
            </span>
        </nav>

        <div class="content">
            <div class="common" style="background-color: #FFFFFF;border-bottom: 0.1rem solid #c2ccd1;">
                <span class="pull-right smalltex" style="margin-right: 18px"><?php echo $cid['name']; ?></span>
                <span class="boldtex" style="margin-left: 0.5rem">分组名称</span>
            </div>
            <input type="hidden" value="<?php echo $cid['sgid']; ?>" id="sgid">
            <input type="hidden" value="<?php echo $cid['sids']; ?>" id="sids">
            <div class="commo">
                <div class="commo1"><p style="margin-top: 11px"><span class="boldtex2" style="margin-left: 0.5rem">分组学员</span></p>
                </div>

                <div class="commo2">
                    <div class="commo3">
                        <span class="smalltex pull-right" style="margin-right: 16px" id="chooses"><span class="icon icon-right"></span></span></div>
...
<script>
    $(function () {
        $('#delete').click(function () {
            window.location.href = '/school/public/index/student/del?sgid='+$('#sgid').val();
        });
        $('#chooses').click(function () {
            window.location.href = '/school/public/index/student/chooses?sgid='+$('#sgid').val();
        });
        $('#change').click(function () {
            window.location.href = '/school/public/index/student/change?sgid='+$('#sgid').val()+'&sids='+$('#sids').val();
        });
