<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"/var/www/html/school/public/../application/mobil/view/arrange/index.html";i:1513766055;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-group">
    ...
    <div class="page page-current" id='router'>
        ...
        <header class="bar bar-nav" style="background-color: #e6e6e6">
            <a class="button button-link button-nav pull-left external" href="<?php echo url('transinfo/handtran'); ?>" style="width: 5%;color: #999999">
            ...
            <div class="content-block">
                <div class="tabs">
                    <div id="tab1" class="tab active">
                        <div class="content-block">
                            ...
                            <label for="<?php echo $vo['sid']; ?>"><div class="news-item clearfix">
                                <!--<input class="pull-left" style="margin-top: 1.1rem" value="<?php echo $vo['sid']; ?>" type="checkbox" id="<?php echo $vo['sid']; ?>" name="chk">--><input onchange="changeimg(this);" class="pull-left" style="margin-top: 1.1rem" value="<?php echo $vo['sid']; ?>" type="checkbox" id="<?php echo $vo['sid']; ?>" name="chk"><img id="<?php echo $vo['sid']; ?>1" class="pull-left ssmall" src="__IMG__/ios/icon_checkbox_checked@3x.png">
                    ...
                    <div id="tab2" class="tab">
                        <div class="content-block">
                            <?php if($unconfirmed == null): ?>
                            <div class="img-div">
                                <img src="__IMG__/ios/416877607.jpg"><br/>
                                这个暂时没有数据哦！
                            </div>
                            <?php endif; if(is_array($unconfirmed) || $unconfirmed instanceof \think\Collection || $unconfirmed instanceof \think\Paginator): $i = 0; $__LIST__ = $unconfirmed;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    ...
                    <div id="tab3" class="tab">
                        <div class="content-block">
                            ...
                            <?php endif; if(is_array($confirmed) || $confirmed instanceof \think\Collection || $confirmed instanceof \think\Paginator): $i = 0; $__LIST__ = $confirmed;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <div class="news-item clearfix">
                                <div class="news-image">
                                    <a href="#"><img src="<?php if($vo['headimg'] != ''): ?>__PIC__<?php echo $vo['headimg']; else: ?>__IMG__/ios/icon_head_portrait@3x.png<?php endif; ?>"></a>
                                </div>
                    ...
                    <div id="tab4" class="tab">
                        <div class="content-block">
                            ...
                            <?php endif; if(is_array($reject) || $reject instanceof \think\Collection || $reject instanceof \think\Paginator): $i = 0; $__LIST__ = $reject;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <div class="news-item clearfix">
                                <div class="news-image">
