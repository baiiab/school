<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"D:\kinggsoft\phpstudy\WWW\school\public/../application/admin\view\guardian\lst.html";i:1510800786;s:81:"D:\kinggsoft\phpstudy\WWW\school\public/../application/admin\view\common\top.html";i:1510724315;s:82:"D:\kinggsoft\phpstudy\WWW\school\public/../application/admin\view\common\left.html";i:1510805509;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title></title>
...
//            alert(document.getElementById("search").value);die;
            window.location.href = "searchGuardian?id="+document.getElementById("search").value;
        }
    </script>
</head>
<body>
...
<button type="button" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('guardian/addGuardian'); ?>'"> <i class="fa fa-plus"></i> 添加监护人
</button>

<button type="button" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('guardian/outexcel'); ?>'"> </i> 导出监护人信息
</button>

    <div style="display: inline-block">
    <form action="<?php echo url('guardian/importExcel'); ?>" enctype="multipart/form-data"
          method="post">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                                        <tr>
                                <td align="center"><?php echo $vo['gid']; ?></td>
                                <td align="center"><?php echo $vo['gname']; ?></td>
                                <td align="center"><?php echo $vo['mobile']; ?></td>
                                <td align="center"><?php echo $vo['num']; ?></td>
                                <td align="center">
                                    <a href="<?php echo url('guardian/edit',array('gid'=>$vo['gid'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗','<?php echo url('guardian/del',array('gid'=>$vo['gid'])); ?>')" class="btn btn-danger btn-sm shiny">
