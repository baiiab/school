<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"D:\kinggsoft\phpstudy\WWW\school\public/../application/mobil\view\transinfo\recedetail.html";i:1512699914;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <div id="tab1" class="tab active">
                        <div class="content-block">
                            ...
                            <div class="news-item clearfix">
                                ...
                                <span class="pull-right button button-round smalltex" style="margin-top: 1.2rem;margin-right: 16px;width: 2.5rem" onclick="reject(this.innerHTML);" type="button">驳回<span style="display: none">,<?php echo $vo['name']; ?>,<?php echo $vo['sid']; ?>,<?php echo $vo['cid']; ?>,</span></span>
                            </div>
