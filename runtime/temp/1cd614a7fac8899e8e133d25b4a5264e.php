<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"D:\kinggsoft\phpstudy\WWW\school\public/../application/mobil\view\transinfo\recedetail.html";i:1511860435;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="page">
        ...
        <nav class="bar bar-tab" id="tools">
            ...
            <span class="tab-item external">
                <span class="tab-label" onclick="change();">确认接收</span>
            </span>
        </nav>
        ...
        <div class="content">
            <div class="buttons-tab">
                <a href="#tab1" id="tabb0" class="tab-link active button">未确认</a>
                <a href="#tab2" id="tabb1" class="tab-link button">已确认</a>
                <a href="#tab3" id="tabb2" class="tab-link button">已驳回</a>
            </div>
                    ...
                    <div id="tab1" class="tab active">
                        <div class="content-block">
                            ...
                            <div class="news-item clearfix">
                                ...
                                <span class="pull-right button button-round" style="margin-top: 1rem;width: 3rem" onclick="reject(this.innerHTML);" type="button">驳回<span style="display: none">,<?php echo $vo['name']; ?>,<?php echo $vo['sid']; ?>,<?php echo $vo['cid']; ?>,</span></span>
                            </div>
                    ...
                    <div id="tab3" class="tab">
                        <div class="content-block">
                            ...
                            <div class="news-item clearfix">
                                ...
                                <p class="smalltex"><?php echo $vo['reason']; ?></p></div>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </div>
                    </div>
                </div>
