<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"D:\kinggsoft\phpstudy\WWW\school\public/../application/admin\view\teacher\addteacher.html";i:1513835836;s:81:"D:\kinggsoft\phpstudy\WWW\school\public/../application/admin\view\common\top.html";i:1513768045;s:82:"D:\kinggsoft\phpstudy\WWW\school\public/../application/admin\view\common\left.html";i:1512960216;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
	    <meta charset="utf-8">
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">新增教师</span>
            </div>
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        <div class="form-group">
                            <label for="tid" class="col-sm-2 control-label no-padding-right">教师编号</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="tid" placeholder="" name="tid" required="" type="number">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            <label for="tname" class="col-sm-2 control-label no-padding-right">姓名</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="tname" placeholder="" name="tname" required="" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="tname" class="col-sm-2 control-label no-padding-right">手机号</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="mobile" required="" name="mobile" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>

                        <div class="form-group">
                            <label for="tname" class="col-sm-2 control-label no-padding-right">科目名称</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            <label for="cid" class="col-sm-2 control-label no-padding-right">负责年级</label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group" id='cid' >
                            <label for="cid" class="col-sm-2 control-label no-padding-right">负责班级</label>
                            <div class="col-sm-6">
                                <select name='cid' id="choose">
                                    <option>请选择班级</option>
                                </select>
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
