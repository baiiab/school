<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"D:\kinggsoft\phpstudy\WWW\school\public/../application/index\view\student\addgroup.html";i:1512443980;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="page">
        ...
        <div class="content">
            <div class="common" style="background-color: #FFFFFF;border-bottom: 0.1rem solid #c2ccd1;">
                <span class="pull-right"><input class="boldtex" id="name" style="text-align: right;margin-right: 18px;border: none" placeholder="请输入分组名称"></span>
