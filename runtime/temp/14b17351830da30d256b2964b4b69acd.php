<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"D:\kinggsoft\phpstudy\WWW\school\public/../application/mobil\view\arrange\confirm.html";i:1512731986;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="page">
        ...
        <nav class="bar bar-tab tooltex" id="tools">
            <span class="tab-item external">
                <span class="tab-label" style="color: #FFFFFF" id="change">确认安排</span>
            </span>
        </nav>
