<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:91:"D:\kinggsoft\phpstudy\WWW\school\public/../application/admin\view\guardian\addguardian.html";i:1510800438;s:81:"D:\kinggsoft\phpstudy\WWW\school\public/../application/admin\view\common\top.html";i:1510724315;s:82:"D:\kinggsoft\phpstudy\WWW\school\public/../application/admin\view\common\left.html";i:1510805509;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
	    <meta charset="utf-8">
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">新增监护人</span>
            </div>
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        <div class="form-group">
                            <label for="tid" class="col-sm-2 control-label no-padding-right">监护人编号</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="tid" placeholder="" name="gid" required="" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="gname" placeholder="" name="gname" required="" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
