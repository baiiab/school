<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"/var/www/html/school/public/../application/admin/view/attendance/sendmsg.html";i:1513672168;s:69:"/var/www/html/school/public/../application/admin/view/common/top.html";i:1513768045;s:70:"/var/www/html/school/public/../application/admin/view/common/left.html";i:1512960216;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
	    <meta charset="utf-8">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="#">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('sysnews',['id'=>$status]); ?>">系统消息</a>
                    </li>
                                        <li class="active">发送系统消息</li>
                                        </ul>
                </div>
                <!-- /Page Breadcrumb -->
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        <input class="form-control" placeholder="" name="status" value="<?php echo $status; ?>" type="hidden">
                        <div class="form-group">
                            <label class="col-sm-2 control-label no-padding-right">消息内容</label>
                            <div class="col-sm-6">
                                <textarea class="form-control" placeholder="" name="content" required="" type="text"></textarea>
                            </div>
                            <p class="help-block col-sm-4 red">* 必填，200字内</p>
                        </div>  
                        <div class="form-group">
