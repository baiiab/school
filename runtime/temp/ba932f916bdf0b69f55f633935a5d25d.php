<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"/var/www/html/school/public/../application/index/view/transinfo/recedetail.html";i:1514255148;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-group">
    ...
    <div class="page">
        ...
        <header class="bar bar-nav" style="background-color: #e6e6e6">
            <a class="button button-link button-nav pull-left external" href="<?php echo url('transinfo/handtran'); ?>" style="color: #999999">
                    ...
                    <div id="tab1" class="tab active">
                        <div class="content-block">
                            ...
                            <label for="<?php echo $vo['sid']; ?>"><div class="news-item clearfix">
                                ...
                                <span class="pull-right button button-round smalltex" style="margin-top: 22px;margin-right: 16px;width: 2.5rem;color: #0894ec" onclick="reject(this.innerHTML);" type="button">驳回<span style="display: none">,<?php echo $vo['name']; ?>,<?php echo $vo['sid']; ?>,<?php echo $vo['cid']; ?>,</span></span>
                            </div></label>
                        ...
                        <div class="content-block">
                            ...
                            <div class="news-item clearfix">
                                ...
                                <div style="float: left;">
                                    ...
                                    <p class="smalltex" style="margin-top: 0.2rem"><?php echo $vo['sex']; ?>&nbsp;<?php echo $vo['cid']; ?></p></div>
                                <?php if($vo['reason'] != ''): ?>
                                <span class="pull-right smalltex" style="margin-top: 1.3rem;margin-right: 16px"><?php echo $vo['reason']; ?></span><?php else: ?>
                                    <span class="pull-right button button-round smalltex" style="margin-top: 22px;margin-right: 16px;width: 2.5rem;color: #0894ec" onclick="exce(this.innerHTML);" type="button">异常<span style="display: none">,<?php echo $vo['name']; ?>,<?php echo $vo['sid']; ?>,<?php echo $vo['cid']; ?>,</span></span><?php endif; ?>
                            </div>
