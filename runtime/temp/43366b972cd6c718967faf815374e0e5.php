<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/var/www/html/school/public/../application/mobil/view/student/addstudent.html";i:1513920625;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <form id="myForm" action="" enctype="multipart/form-data" method="post">
                    ...
                    <div class="common">
                        ...
                        <p class="smalltex"><span class="icon icon-down pull-right" id="sp"
                            ...
                            <select class="pull-right" id="cid" name="cid" onmousedown="if(this.options.length>6){this.size=5}" onblur="this.size=0" onchange="this.size=0">
