<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"/var/www/html/school/public/../application/admin/view/student/addstudent.html";i:1513846552;s:69:"/var/www/html/school/public/../application/admin/view/common/top.html";i:1513768045;s:70:"/var/www/html/school/public/../application/admin/view/common/left.html";i:1512960216;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
	    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="sid" placeholder="" name="sid" required="" type="number">
                            </div>
                        ...
                        <div class="form-group" id='cid' >
                            ...
                            <div class="col-sm-6">
                                <select id="choose" name='cid'><option>请选择班级</option></select>
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        <div class="form-group">
                            <label for="detid" class="col-sm-2 control-label no-padding-right">默认监护人</label>
                            <div class="col-sm-6">
                                <select name="detid" id="detid">
                                    ...
                                    <option value="<?php echo $vo['mobile']; ?>"><?php echo $vo['gname']; ?></option>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
