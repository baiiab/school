<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\kinggsoft\phpstudy\WWW\school\public/../application/index\view\news\home.html";i:1512288911;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="page">
        ...
        <div class="content">
            <div class="center-item" onclick="javascript:window.location.href = '<?php echo url('news/sysnews'); ?>'">
                ...
                <p class="item-p2"><?php echo $sys['0']['content']; ?></p></div>
            </div>
            <div class="center-item" onclick="javascript:window.location.href = '<?php echo url('news/transnews'); ?>'">
                ...
                <p class="item-p2"><?php echo $tran['0']['content']; ?></p></div>
            </div>
        </div>
    </div>
    <!-- 其他的单个page内联页（如果有） -->
