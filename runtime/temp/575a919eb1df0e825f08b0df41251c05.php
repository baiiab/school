<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"D:\kinggsoft\phpstudy\WWW\school\public/../application/mobil\view\guardian\home.html";i:1512459309;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="page-group">
    ...
    <div class="page">
        ...
        <div class="content">
            ...
            <div class="common" style="height: 6rem">
            ...
            <div class="common">
                <p onclick="javascript:window.location.href = '<?php echo url('news/home'); ?>'"><a class="icon icon-right pull-right" style="margin-right: 0.5rem"></a>
                    ...
                    <span class="pull-right" style="background-color: #F04545;padding-left: 0.5rem;margin-right: 5px;margin-top: 0.1rem;padding-right: 0.5rem;font-size: 14px;border-radius: 10px;color: #FFFFFF">99</span>
